...
const experience = [
  ...
  },
  {
    ...
    points: [
      "Engineered SQL- and Python-driven ETL pipelines for marketing, media spend, and sales datasets, enabling attribution analysis and campaign performance reporting.",
      "Built curated analytical datasets and Snowflake-style reporting layers that supported unified measurement, business KPIs, and self-service analytics workflows.",
      "Automated recurring ingestion, transformation, and validation processes using Python and cloud data services, reducing manual reporting effort and improving delivery speed.",
      "Partnered with analysts and stakeholders to deliver reliable Power BI and Tableau reporting models for conversion, ROI, and operational performance insights.",
      "Strengthened data quality by documenting transformation rules, validating source-to-target logic, and improving processing efficiency for large-scale reporting pipelines.",
    ],
