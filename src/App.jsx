...
const experience = [
  ...
  },
  {
    ...
    points: [
      "Designed and implemented scalable ETL/ELT pipelines in Databricks using PySpark and Delta Lake following Medallion Architecture (Bronze/Silver/Gold).",
      "Developed optimized Spark workflows leveraging partitioning, caching, and query tuning to improve performance by 35%.",
      "Built governed datasets using Unity Catalog with RBAC controls, schema enforcement, and metadata tracking.",
      "Implemented CDC-based ingestion pipelines using AWS DMS and incremental load strategies.",
      "Developed complex SQL transformations using joins, CTEs, and window functions for analytics-ready datasets.",
      "Validated structured and semi-structured data (CSV, JSON, XML, Parquet, Avro) including schema checks, null handling, and delimiter validation.",
      "Built automated regression and smoke test frameworks in Python to ensure transformation accuracy.",
      "Orchestrated workflows using Databricks Workflows and Azure Data Factory.",
      "Designed star and dimension models to support reporting and BI dashboards.",
      "Conducted source-to-target reconciliation ensuring 99%+ data accuracy across systems.",
    ],
    tags: ["Databricks", "PySpark", "Delta Lake", "Unity Catalog", "AWS DMS", "Azure Data Factory"],
  },
  {
